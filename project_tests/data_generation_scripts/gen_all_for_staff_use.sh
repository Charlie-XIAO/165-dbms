...
python milestone4.py "${TBL_SIZE}" "${JOIN_DIM1_SIZE}" "${JOIN_DIM2_SIZE}" "${JOIN_SELECT_SIZE}" \
  "${RAND_SEED}" "${ZIPFIAN_PARAM}" "${NUM_UNIQUE_ZIPF}" "${OUTPUT_TEST_DIR}" "${DOCKER_TEST_DIR}"
